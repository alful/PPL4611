...
public class DaftarGameClientAdaptersAdm extends RecyclerView.Adapter<DaftarGameClientAdaptersAdm.DaftarGameClientViewHolder>{
    private Context context;
    private List<CKategori> CKategoriList;

    public DaftarGameClientAdaptersAdm(Context context, List<CKategori> CKategoriList) {
    ...
    @NonNull
    @Override
    public DaftarGameClientAdaptersAdm.DaftarGameClientViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DaftarGameClientAdaptersAdm.DaftarGameClientViewHolder(LayoutInflater.from(context).inflate(R.layout.lihat_game_client_recycler_row, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull DaftarGameClientAdaptersAdm.DaftarGameClientViewHolder holder, int position) {
    ...
    private void setGambarGameRecycler(RecyclerView recyclerView, final ArrayList<CatalogBoardGame> ALCatalogBoardGame){
        final DaftarGameClientGambarGameRecyclerAdaptersAdm daftarGameClientGambarGameRecyclerAdapter = new DaftarGameClientGambarGameRecyclerAdaptersAdm(context, ALCatalogBoardGame);
