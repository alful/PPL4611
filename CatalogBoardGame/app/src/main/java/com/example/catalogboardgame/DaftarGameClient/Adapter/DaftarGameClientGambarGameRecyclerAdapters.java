...
public class DaftarGameClientGambarGameRecyclerAdapters extends RecyclerView.Adapter<DaftarGameClientGambarGameRecyclerAdapters.DaftarGameClientGambarGameViewHolder> {
    private Context context;

    private ArrayList<CatalogBoardGame> ALCatalogBoardGame;

    public DaftarGameClientGambarGameRecyclerAdapters(Context context, ArrayList<CatalogBoardGame> ALCatalogBoardGame) {
        this.context = context;
        this.ALCatalogBoardGame = ALCatalogBoardGame;
    }
    @NonNull
    @Override
    public DaftarGameClientGambarGameRecyclerAdapters.DaftarGameClientGambarGameViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DaftarGameClientGambarGameRecyclerAdapters.DaftarGameClientGambarGameViewHolder(LayoutInflater.from(context).inflate(R.layout.lihat_game_client_recycler_row_gambar_game, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull DaftarGameClientGambarGameRecyclerAdapters.DaftarGameClientGambarGameViewHolder holder, final int position) {
        ...
        holder.IVGambarGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intents = new Intent(context.getApplicationContext(), BacaGameClients.class);
