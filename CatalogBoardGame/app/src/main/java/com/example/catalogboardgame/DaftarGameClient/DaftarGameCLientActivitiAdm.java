...
import com.example.catalogboardgame.DaftarGameClient.Adapter.DaftarGameClientAdaptersAdm;
...
public class DaftarGameCLientActivitiAdm extends AppCompatActivity {
    RecyclerView RVDaftarGameClient;
    DaftarGameClientAdaptersAdm daftarGameClientAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_game_c_lient_activiti_adm);
        ...
        daftarGameClientAdapter = new DaftarGameClientAdaptersAdm(this, CKategoriList);
